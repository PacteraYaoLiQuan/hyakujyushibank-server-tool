...
import com.scsk.service.PushRecordAppDetailSelService;
import com.scsk.util.LogInfoUtil;
import com.scsk.util.ResultMessages;

@Controller
@RequestMapping("/protected")
public class PushRecordAppDetailController {
    
    @Autowired
    PushRecordAppDetailSelService pushRecordAppDetailSelService;
     ...
     */
    @RequestMapping(value = "/push/pushRecordAppDetail", method = RequestMethod.GET, produces = "application/json")
    public ResponseEntity<ResponseEntityVO<BaseResVO>> detailShow(
        ...
        try {
            // 申込詳細情報取得
        	BaseResVO ba = pushRecordAppDetailSelService
                    .execute(baseResVO);
            // ヘッダ設定（処理成功の場合）
