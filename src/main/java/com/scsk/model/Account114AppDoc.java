...
public class Account114AppDoc extends UtilDoc {
    
    // ドキュメントタイプ
    private final String docType = Constants.ACCOUNT_APP;
    // 受付番号
    ...
    // 市区町村・番地・アパート・マンション名(読取結果確認)
    private String addressR = "";
    // 郵便番号(入力エリア)
    private String postCode = "";
    // 都道府県(入力エリア)
    private String prefecturesCode = "";
    // 市区町村・番地・アパート・マンション名(入力エリア)
    private String address = "";
    // 市区町村・番地・アパート・マンション名（カナ）
    ...
    // 114ダイレクトバンキングの1日あたりの振込限度額
    private String creditlimit = "";
    // 114ダイレクトバンキングのログオンパスワード
    private String onlinePassword = "";
    // 114ダイレクトバンキングのログオンパスワード（確認）
    private String onlinePasswordConfirm = "";
    // アンケート：口座開設をアプリからお申込みできることをどのようにしてお知りになりましたか？（複数回答可）
    private String knowProcess = "";
    // アンケート：インターネットからお申込みいただいた理由は何ですか？（複数回答可）
