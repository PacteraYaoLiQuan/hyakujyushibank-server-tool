 ...
 * 口座開設DOC
 */
public class AccountYamaGataAppDoc extends UtilDoc {
	
	// ドキュメントタイプ
	private String docType = Constants.ACCOUNT_DOCTYPE;
	// ユーザーID
	...
	// 取引目的
	private List<String> accountPurpose = new ArrayList<String>();
	// 取引目的(その他)
	private String accountPurposeOther = "";
	// 職業
	private List<String> jobKbn = new ArrayList<String>();
	// 職業(その他)
