...
public class PushMessageDetailUpdateReqVO {
    private List<String> pushMessageCsv;
	public List<String> getPushMessageCsv() {
        return pushMessageCsv;
    }

    public void setPushMessageCsv(List<String> pushMessageCsv) {
        this.pushMessageCsv = pushMessageCsv;
    }

    private List<PushMessageInitVO> pushMessageList;

	public List<PushMessageInitVO> getPushMessageList() {
		return pushMessageList;
	}

	public void setPushMessageList(List<PushMessageInitVO> pushMessageList) {
