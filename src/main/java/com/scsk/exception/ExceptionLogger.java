 ...
 *       com.scsk.exception.SystemException: system error.
 *           at org.xxxx ...
 *           at org.xxxx ...
 *           at org.xxxx ...
 *           at org.xxxx ...
...
public class ExceptionLogger implements InitializingBean {
     ...
     * <p>
     * If exception resolution object is not set, use {@link com.scsk.exception.DefaultExceptionLevelResolver}.
     * </p>
    ...
    private final class InfoLogger implements LogLevelWrappingLogger {
         ...
         * @see com.scsk.common.exception.ExceptionLogger.LogLevelWrappingLogger#isEnabled()
         */
        @Override
         ...
         * </p>
         * @see com.scsk.exception.ExceptionLogger.LogLevelWrappingLogger#log(java.lang.String,
         *      java.lang.Exception)
         */
        @Override
    ...
    private final class WarnLogger implements LogLevelWrappingLogger {
         ...
         * @see com.scsk.exception.ExceptionLogger.LogLevelWrappingLogger#isEnabled()
         */
        @Override
        public boolean isEnabled() {
