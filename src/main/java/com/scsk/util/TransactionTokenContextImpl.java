...
public class TransactionTokenContextImpl implements TransactionTokenContext {
     ...
     * @see com.scsk.util.TransactionTokenContext#createToken()
     */
    @Override
     ...
     * {@link com.scsk.util.TransactionTokenContextImpl.ReserveCommand#REMOVE_TOKEN}
     * @see com.scsk.util.TransactionTokenContext#removeToken()
     */
    @Override
