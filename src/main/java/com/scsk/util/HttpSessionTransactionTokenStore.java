...
import com.scsk.util.TokenStringGenerator;
...
public class HttpSessionTransactionTokenStore implements TransactionTokenStore {
     ...
     * @see com.scsk.util.TransactionTokenStore#getAndClear(com.scsk.util.TransactionToken)
     ...
     * @see com.scsk.util.TransactionTokenStore#remove(com.scsk.util.TransactionToken)
     */
    @Override
     ...
     * namespace.
     * @see com.scsk.util.TransactionTokenStore#createAndReserveTokenKey(java.lang.String)
     */
    @Override
     ...
     * @see com.scsk.util.TransactionTokenStore#store(com.scsk.util.TransactionToken)
     */
    @Override
