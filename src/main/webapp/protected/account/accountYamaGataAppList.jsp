		...
		<div class="card">
			...
			<div class="card-body card-padding detail-popup scrool-size-1">
				...
				<div class="row detail-c-item">
					...
					<div class="col-sm-3">
						<div class="text-item">
							<span>{{modalInstanceCtrl.sexKbn | sexKbnTitle}}</span>
						</div>
					</div>
				</div>
                <div class="row detail-c-item">
					...
					<div class="col-sm-3">
						<div class="text-item">
							<span>{{modalInstanceCtrl.ordinaryDepositEraKbn | ordinaryDepositEraKbnTitle}}</span>
						</div>
					</div>
					...
					<div class="col-sm-3">
						<div class="text-item">
							<span>{{modalInstanceCtrl.eraBirthday}}</span>
						</div>
					</div>
				</div>
                <div class="row detail-c-item">
					...
					<div class="col-sm-2">
						<div class="text-item">申込口座の種類</div>
					</div>
					<div class="col-sm-3">
						<div class="text-item">
							<span>{{modalInstanceCtrl.accountType | accountTypeTitle}}</span>
						</div>
					</div>
				</div>
				<div class="row detail-c-item">
					...
					<div class="col-sm-8">
						<div class="text-item">
							<span>{{modalInstanceCtrl.postCode}}</span><br /> 
                            <span>{{modalInstanceCtrl.prefecturesCode | prefecturesCodeTitle}}</span><br />
				...
				<div class="row detail-c-item">
					...
					<div class="col-sm-8">
						<div class="text-item">
                            ...
                            <span>勤務先電話番号&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span>{{modalInstanceCtrl.workTeleNumber}}</span><br />
						</div>
					</div>
				</div>
                <div class="row detail-c-item">
                    ...
                    <div class="col-sm-3">
						<div class="text-item">
							<span><option
									ng-repeat="jobKbn in modalInstanceCtrl.jobKbn">{{jobKbn
									| jobKbnTitle: modalInstanceCtrl.jobKbnOther}}<br />
								</option></span>
						</div>
					</div>
                </div>
                <!--<div class="row detail-c-item">
					...
					<div class="col-sm-3">
						<div class="text-item">
							<span><option
									ng-repeat="businessType in modalInstanceCtrl.businessType">{{businessType
									| businessTypeTitle: modalInstanceCtrl.businessTypeOther}}<br />
								</option></span>
						</div>
					</div>
				</div>--!>
                ...
                <!--<div class="row detail-c-item">
					...
					<div class="col-sm-8">
						<div class="text-item">
							<span>{{modalInstanceCtrl.workPostCode}}</span><br /> 
                            <span>{{modalInstanceCtrl.workPrefecturesCode | prefecturesCodeTitle}}</span><br />
                            <span>{{modalInstanceCtrl.workAddress}}</span>
						</div>
					</div>
				</div>--!>
				<div class="row detail-c-item">
                ...
                <div class="row detail-c-item">
					...
					<div class="col-sm-3">
						<div class="text-item">
							<span><option
									ng-repeat="accountPurpose in modalInstanceCtrl.accountPurpose">{{accountPurpose
									| accountPurposeTitle: modalInstanceCtrl.accountPurposeOther}}<br />
								</option></span>
						</div>
					</div>
					<div class="col-sm-2">
					...
					<div class="col-sm-3">
						<div class="text-item">
							<div class="text-item">
							<span>{{modalInstanceCtrl.knowProcess | knowProcess2Title:
								modalInstanceCtrl.knowProcessOther}}</span>
						    </div>
						</div>
					</div>
				</div>
                ...
                <div class="row detail-c-item">
					...
					<div class="col-sm-3">
						<div class="text-item">
							<span>{{modalInstanceCtrl.ipAddress}}</span>
						</div>
					</div>
				</div>
                <div class="row detail-c-item">
					...
					<div class="col-sm-3">
						<div class="text-item">
							<span>{{modalInstanceCtrl.bankbookDesignKbn | bankbookDesignKbnTitle}}</span>
						</div>
					</div>
				</div>
				<div class="row detail-c-item">
					...
					<div class="col-sm-3">
						<div class="text-item">
							<span>{{modalInstanceCtrl.cardDesingKbn | cardDesingKbnTitle}}</span>
						</div>
					</div>
				</div>              
                <div class="row detail-c-item">
					...
					<div class="col-sm-3">
						<div class="text-item">
							<span>{{modalInstanceCtrl.salesOfficeOption | salesOfficeOptionTitle}}</span>
						</div>
					</div>
				</div>
				<div class="row detail-c-item">
